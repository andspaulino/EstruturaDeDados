...
int main()
{
    ...
    //Imprimi a arvore.
    printf("A arvore gerada: \n");
    exibirArvore(r);

    //Valor do elemento raiz
    printf("\n\nValor: %d", r->chave);

    //Busca determinado elemento na arvore
    printf("\nQual valor você quer buscar na arvore?\n");
    scanf("%d", &valor);
    NO busca = contem(valor, r);
    printf("\nValor: %d", busca->chave);

    //Exibe o total de nos.
    printf("\nTotal raiz: %d\n", totalDeNos(r));
